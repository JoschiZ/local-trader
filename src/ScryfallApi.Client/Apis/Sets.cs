...
public class Sets : ISets
{
    ...
    /// </summary>
    /// <returns></returns>
    public Task<ScryfallResult<ResultList<Set>>> Get() => _restService.GetAsync<ResultList<Set>>("/sets");
    ...
    /// <returns></returns>
    public Task<ScryfallResult<Set>> Get(string setCode) => _restService.GetAsync<Set>($"/sets/{setCode}");
}
